...
import Website from "@/components/website/Gallery1";
                        ...
                        <div className="row">
                          ...
                          <div className="col-md-8 offset-md-2">
                            ...
                            <h1 className="hs-title-1 mb-0">
                              ...
                              >
                                <AnimatedText text="Expert Web Development by SquareCom IT Solutions" />
                              </span>
                            </h1>
                          </div>
                          {/* End Page Title */}
              ...
              <>
                <>
                  ...
                  <section className="page-section light-content pt-0">
                    <Website itemsLength={8} parantClass="col-md-4" />
                  </section>
                  {/* End Section */}
                  {/* Divider */}
